...
<section class="content">
    ...
    <div class="box box-solid">
        <div class="box-header with-border" style="padding-top:5px;padding-bottom:5px;" >
            ...
            <a  class="btn btn-primary btn-sm" >Deliver to</a>
            <a class="btn btn-success btn-sm" >Print</a>

            <label class="pull-right" >&nbsp;&nbsp;&nbsp;</label>
            <a class="btn btn-arrow-right pull-right disabled bg-gray" >Delivered</a>
            ...
            <table class="table" >
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" name="lokasi_galian" class="form-control" value="{{$data->lokasi_galian}}" >

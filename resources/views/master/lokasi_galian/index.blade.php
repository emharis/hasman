...
<section class="content">
    ...
    <div class="box box-solid">
        <div class="box-header with-border" >
            <a class="btn btn-primary" id="btn-add" href="master/lokasi/create" ><i class="fa fa-plus-circle" ></i> Tambah Baru</a>
...
(function ($) {
    ...
    $(document).on('click','.row-to-edit',function(){        
        ...
        location.href = 'master/lokasi/edit/' + data_id ;        
    });
    ...
    $('#btn-delete').click(function(e){
        if(confirm('Anda akan menhapus data ini?')){
            ...
            var deleteForm = $('<form>').attr('method','POST').attr('action','master/lokasi/delete');

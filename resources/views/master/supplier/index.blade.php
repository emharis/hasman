            ...
            <table class="table table-bordered table-condensed table-striped table-hover" id="table-data" >
                ...
                <tbody>
                    ...
                    <tr data-rowid="{{$rownum}}" data-id="{{$dt->id}}">
                        ...
                        <td>
                            <a class="btn btn-primary btn-xs" href="master/supplier/edit/{{$dt->id}}" ><i class="fa fa-edit" ></i></a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
...
(function ($) {
    ...
    $('#btn-delete').click(function(e){
        if(confirm('Anda akan menhapus data ini?')){
            ...
            var deleteForm = $('<form>').attr('method','POST').attr('action','master/supplier/delete');

...
<section class="content">
    ...
    <div class="box box-solid">
        <div class="box-header with-border">
            <a class="btn btn-primary" id="btn-add" href="master/unit/create" ><i class="fa fa-plus-circle" ></i> Tambah Baru</a>
            ...
            <table class="table table-bordered table-condensed table-striped table-hover" id="table-data" >
                ...
                <tbody>
                    ...
                    <tr data-rowid="{{$rownum}}" data-id="{{$dt->id}}">
                        ...
                        <td class="text-center" >
                            <a class="btn btn-primary btn-xs" href="master/unit/edit/{{$dt->id}}" ><i class="fa fa-edit" ></i></a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
...
(function ($) {
    ...
    $(document).on('click','.row-to-edit',function(){        
        ...
        location.href = 'master/unit/edit/' + data_id ;        
    });
    ...
    $('#btn-delete').click(function(e){
        if(confirm('Anda akan menhapus data ini?')){
            ...
            var deleteForm = $('<form>').attr('method','POST').attr('action','master/unit/delete');

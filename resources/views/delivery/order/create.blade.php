...
<section class="content-header">
    <h1>
        <a href="delivery/order" >Delivery Order</a> <i class="fa fa-angle-double-right" ></i> New
    </h1>
</section>
...
<section class="content">
    ...
    <div class="box box-solid">
        <div class="box-header with-border" style="padding-top:5px;padding-bottom:5px;" >
            <label> <small>Delivery Order</small> <h4 style="font-weight: bolder;margin-top:0;padding-top:0;margin-bottom:0;padding-bottom:0;" >New</h4></label>
        ...
        <div class="box-body">
            <table class="table" >
                <tbody>
                    <tr>
                        ...
                        <td class="col-lg-4" >
                            <input type="text" name="customer" autofocus class="form-control " required  >
                            <input type="hidden" name="customer_id" autofocus class="form-control " required>
                        </td>
                        <td class="col-lg-2" >
                    ...
                    <tr>
                        ...
                        <td colspan="3" >
                            <input type="text" name="armada" class="form-control "  required >
                            <input type="hidden" name="armada_id" class="form-control "  required >
                        </td>
                    ...
                    <tr>
                        ...
                        <td >
                            <input type="text" name="lokasi_galian"  class="form-control "  >
                            <input type="hidden" name="lokasi_galian_id"  class="form-control"  >
                        </td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="hidden" name="kabupaten_id" class="form-control "  required >
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="hidden" name="desa_id" class="form-control "  required >
                        </td>
                    </tr>
                </tbody>
            </table>
            ...
            <table id="table-product" class="table table-bordered table-condensed" >
                ...
                <tbody>
                    <tr class="hide" id="row-add-product"  >
                        ...
                        <td>
                            <input autocomplete="off" type="text"  data-barangid="" data-kode="" class=" form-control input-product input-sm input-clear">
                        </td>
                        <td>
                        ...
                        <td>
                            <input autocomplete="off" type="text" class="text-right form-control input-deliveryperson-unit-price input-sm input-clear">
                        </td>
                        <td>
            ...
            <div class="row" >
                <div class="col-lg-8" >
                    ...
                    <i>&nbsp;|&nbsp;</i>
                    <i><span>S.U.P : Deliveryperson Unit Price</span></i>
                </div>
                <div class="col-lg-4" >
...
(function ($) {
    ...
    $('#btn-add-item').click(function(){
        ...
        // $('.input-deliveryperson-unit-price').autoNumeric('init',{
            vMin:'0',
            vMax:'9999999999'
        });
        ...
        input_product.autocomplete({
            serviceUrl: 'delivery/order/get-product',
            params: {  
                        'nama' : function() {
    ...
    // // HITUNG SUBTOTAL
    $(document).on('keyup','.input-deliveryperson-unit-price, .input-quantity',function(){
        generateInput($(this));
    ...
    $('#btn-save').click(function(){
        ...
        so_master.deliveryperson_id = $('input[name=deliveryperson]').data('deliverypersonid');
        ...
        // save ke database
        if(so_master.customer_id != "" && $('input[name=customer]').val() != "" && so_master.deliveryperson_id != "" && $('input[name=deliveryperson]').val() != "" && so_master.order_date != "" && so_barang.barang.length > 0){

            var newform = $('<form>').attr('method','POST').attr('action','delivery/order/insert');

...
<section class="content-header">
    <h1>
        ...
        <a href="payroll/payroll/show-payroll-table/{{$tanggal_gaji}}/ST" >Payroll Staff</a>
        <i class="fa fa-angle-double-right" ></i>
        Edit Payroll
    </h1>
</section>
...
<section class="content">
    <div class="box box-solid">
        <div class="box-header with-border" style="padding-top:5px;padding-bottom:5px;" >
            ...
            <label><h3 style="margin:0;padding:0;font-weight:bold;" >Payroll Staff</h3></label>
            ...
            <div class="col-sm-6" >
              <div class="form-horizontal" >
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" readonly  name="jumlah_presensi" class="form-control text-right" value="{{($data->total_hadir_pagi + $data->total_hadir_siang)/2}}">
                  </div>
                </div>
                <div class="form-group">
                  <label  class="col-sm-4 control-label">Jumlah Gaji</label>
                  <div class="col-sm-8">
                    <input type="text" readonly  name="jumlah_gaji" class="form-control uang text-right" value="{{($data->total_hadir_pagi + $data->total_hadir_siang)/2 * $data->gaji_pokok}}">
                  </div>
                </div>
                <div class="form-group">
                  <label  class="col-sm-4 control-label">Potongan</label>
                  <div class="col-sm-8">
                    <input type="text"   name="potongan" class="form-control uang text-right" >
                  </div>
                </div>
                <hr/>
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" readonly name="gaji_bersih" style="font-size: 16pt; font-weight: bold;background-color: transparent;border:none;border-bottom: thin solid grey;" class="form-control uang text-right" value="{{($data->total_hadir_pagi + $data->total_hadir_siang)/2 * $data->gaji_pokok}}">
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="box-footer" >
          <a class="btn btn-primary" id="btn-save-payroll" >Save</a>
          
          <a class="btn btn-danger" href="payroll/payroll/show-payroll-table/{{$tanggal_gaji}}/ST" >Close</a>
        </div>
...
(function ($) {
  ...
  $('#btn-save-payroll').click(function(){
    ...
    var newform = $('<form>').attr('method','POST').attr('action','payroll/payroll/insert-pay');

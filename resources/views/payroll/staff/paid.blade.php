...
<section class="content">
    <div class="box box-solid">
        <div class="box-header with-border" style="padding-top:5px;padding-bottom:5px;" >
            <button class="btn btn-danger" id="btn-cancel" data-href="payroll/staff/cancel-payroll/{{$data->id}}" >Cancel Payroll</button>
          <div class="btn-group ">
            ...
            <table class="table" >
                <tbody>
                    <tr>
                        ...
                        <td class="col-lg-4" >
                            <input type="text" name="payment_date" class="input-tanggal form-control" value="{{$data->payment_date_formatted}}" required readonly >
                        </td>
                    </tr>
                    <tr>
                      <td>
    ...
    <div class="box box-solid data-payroll" >
            ...
            <table id="table-payroll" class="table table-condensed   " >
                ...
                <tbody>
                    <tr>
                        ...
                        <td></td>
                        <td>Potongan Bon</td>
                        <td class="text-right col-sm-2 col-md-2 col-lg-2 uang" >
                            {{$data->potongan_bon}}
                        </td>
                    </tr>
                    <tr>
        ...
        <div class="box-footer  " >
            ...
            <a class="btn btn-danger" id="btn-close" href="payroll/staff" >Close</a>
        </div>
    </div>

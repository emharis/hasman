...
<section class="content">
    <div class="box box-solid">
            ...
            <div class="col-sm-6" >
              <div class="form-horizontal" >
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text"   name="potongan" class="form-control uang text-right" value="{{$data->potongan}}" >
                  </div>
                </div>
                <hr/>
                <div class="form-group">
        ...
        <div class="box-footer" >
          ...
          <a class="btn btn-success" href="payroll/payroll/validate-pay/{{$data->id}}" ><i class="fa fa-check" ></i> Validate</a>
          <a class="btn btn-danger" href="payroll/payroll/show-payroll-table/{{$data->payment_date_formatted}}/ST" ><i class="fa fa-close" ></i> Close</a>
